...
class SslCommerzPaymentController extends Controller
{
    ...
    BillingDetails::insert([
        'order_id'=>$order_id,
        'customer_id'=>$data->first()->customer_id,
        'billing_name'=>$data->first()->name,
        'billing_email'=>$data->first()->email,
    ...
    ShippingDetails::insert([
        'order_id'=>$order_id,
        'shipping_name'=>$data->first()->shipping_name,
        'shipping_email'=>$data->first()->shipping_email,
        'shipping_mobile'=>$data->first()->shipping_mobile,
        'country_id'=>$data->first()->country_id,
        'city_id'=>$data->first()->city_id,
        'shipping_address'=>$data->first()->shipping_address,
        'zip'=>$data->first()->zip,
