...
<!-- ============================================================== -->
            ...
            <div class="col d-flex align-items-center justify-content-between">
                            ...
                            <div class="fls_last"><a href="{{ route('remove_cart', $cart->id) }}" class="close_slide gray"><i class="ti-close"></i></a></div>
                        </div>
                    </div>
                </li>
                @php
            ...
            @endforeach
                        ...
                        <div class="alert alert-danger">{{ $message }}</div>
                            ...
                            <!-- Coupon -->
								<div class="mb-3">
                                     <form action="" method="GET" class="mb-7 mb-md-0 ">
