                ...
                <input type="hidden" name="customer_id" value="{{ Auth::guard('customerlogin')->id() }}" >
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
										<div class="form-group">
											...
											<input type="text" readonly class="form-control" value="{{ Auth::guard('customerlogin')->user()->name }}" name="billing_name"/>
										</div>
									</div>
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
										<div class="form-group">
											<label class="text-dark">Email *</label>
											<input type="email" readonly class="form-control" value="{{ Auth::guard('customerlogin')->user()->email }}" name="billing_email" />
										</div>
									</div>
                               ...
                               <div class="row mb-2">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                    <div class="form-group">
                                        <label class="text-dark">Full Name</label>
                                        <input type="text" class="form-control" placeholder="City / Town"  name="shipping_name"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                    <div class="form-group">
                                        <label class="text-dark">Email</label>
                                        <input type="text" class="form-control" placeholder="Zip / Postcode" name="shipping_email"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                    <div class="form-group">
                                        <label class="text-dark">Mobile Number *</label>
                                        <input type="text" class="form-control" placeholder="Mobile Number" name="shipping_mobile"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Address" name="shipping_address" />
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
						...
						<div class="col-12 col-lg-4 col-md-12">
							<div class="d-block mb-3">
								...
								@foreach ($carts as $cart)
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-3">
                                                <!-- Image -->
                                                <a href="product.html"><img src="{{ asset('backend/uploads/preview') }}/{{ $cart->rel_to_product->preview }}" alt="..." class="img-fluid"></a>
                                            </div>
							...
							<div class="mb-4">
								<div class="form-group">
									...
									<ul class="no-ul-list">
										<li>
											<input id="c1" class="radio-custom charge" name="charge" type="radio" value="80">
											<label for="c1" class="radio-custom-label">Inside City</label>
										</li>
										<li>
											<input id="c2" class="radio-custom charge" name="charge" type="radio" value="160">
