    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-10 col-lg-8 col-xl-6 text-center">
                ...
                <!-- Text -->
                <p class="ft-regular fs-md mb-5">Your order <span class="text-body text-dark">#{{ $order_id_new }}</span> has been completed. Your order details are shown for your personal accont.</p>
                <!-- Button -->
