                        ...
                        <ul>
                           @foreach ($category as $cat)
                             <li>
                                ...
                                <img  width="25" src="{{ asset('backend/uploads/category_image') }}/{{ $cat->category_image }}" >
                    ...
                    <div class="product_grid card b-0">
                        ...
                        <div class="card-body p-0">
                            <div class="shop_thumb position-relative">
                                <a class="card-img-top d-block overflow-hidden" href="{{ route('product_details', $product->id) }}"><img class="card-img-top" src="{{ asset('backend/uploads/preview') }}/{{ $product->preview }}" alt="..."></a>
                            </div>
                        </div>
                        <div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
                            <div class="text-left">
                                <div class="text-left">
                                    <div class="elso_titl"><span class="small">{{ $product->category_name }}</span></div>
                                    <h5 class="fs-md mb-0 lh-1 mb-1"><a href="{{ route('product_details', $product->id) }}">{{ $product->product_name}}</a></h5>
                                    <div class="star-rating align-items-center d-flex justify-content-left mb-2 p-0">
                                        ...
                                        @if ($product->discount)
                                        <div class="elis_rty"><span class="ft-medium text-muted line-through fs-md mr-2">&#2547;{{ $product->price }} </span>
            ...
            @foreach ($category as $cato)
                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-4">
                    <div class="cats_side_wrap text-center mx-auto mb-3">
                        <div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-4 circle mb-2 border"><a href="javascript:void(0);" class="d-block"><img  width="30" src="{{ asset('backend/uploads/category_image') }}/{{ $cato->category_image }}" class="img-fluid" width="40" alt=""></a></div></div>
                        <div class="sl_cat_02"><h6 class="m-0 ft-medium fs-sm"><a href="javascript:void(0);">{{ $cato->category_name }}</a></h6></div>
                    </div>
                </div>
            @endforeach
