    ...
    <div id="invoiceholder">
        ...
        <div id="invoice" class="effect2">
          ...
          <div id="invoice-top">
            <div class="logo"></div>
            <div class="info">
              <h2>{{ App\Models\BillingDetails::where('order_id', $data)->first()->billing_name }}</h2>
              <p> {{ App\Models\BillingDetails::where('order_id', $data)->first()->billing_email }} </br>
                {{ App\Models\BillingDetails::where('order_id', $data)->first()->mobile }}
              </p>
            </div><!--End Info-->
            <div class="title">
              <h1>Invoice {{ $data }}</h1>
              <p>Issued: {{ App\Models\Order::where('order_id', $data)->first()->created_at->format('d-M-Y') }}</br>
        ...
        @foreach (  App\Models\OrderProduct::where('order_id', $data)->get()  as $product)
             ...
             <tr class="tabletitle">
                ...
                <td class="payment"><h2>${{ App\Models\Order::where('order_id', $data)->first()->discount }}</h2></td>
              </tr>
              ...
              <tr class="tabletitle">
                ...
                <td class="payment"><h2>${{ App\Models\Order::where('order_id', $data)->first()->charge }}</h2></td>
              </tr>
                ...
                <tr class="tabletitle">
                  ...
                  <td class="payment"><h2>${{ App\Models\Order::where('order_id', $data)->first()->total }}</h2></td>
                </tr>
