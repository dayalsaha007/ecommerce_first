            ...
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                                ...
                                <ul aria-expanded="false">
                                    <li><a href="{{ route('add_sub_category') }}">Add Subcategory</a></li>
                                    <li><a href="{{ route('all_sub_category') }}">All Subcategory</a></li>
                            ...
                            <ul aria-expanded="false">
                                <li><a href="{{ route('add_brands') }}">Add Brands</a></li>
                                <li><a href="{{ route('all_brands') }}">All Brands</a></li>
